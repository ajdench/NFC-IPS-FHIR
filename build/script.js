 ...
 * @param {string} hex - Hex color (e.g., '#ffcccc')
...
function createInfoBoxes() {
    ...
    infoBoxConfig.forEach(config => {
        ...
        setTitleAvailability(title, false);
...
// =============================================================================
// CHART.JS PLUGINS - TIMEBASE BACKGROUND SYSTEM
// =============================================================================
...
function processAndRenderAll(viewModel, comparisonViewModel) {
    ...
    appState.comparisonViewModel = comparisonViewModel || null;
...
window.init = init;
window.convertFhirToCodeRef = convertFhirToCodeRef;
window.processAndRenderAll = processAndRenderAll;
